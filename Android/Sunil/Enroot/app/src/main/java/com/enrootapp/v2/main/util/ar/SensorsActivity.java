...
import com.enrootapp.v2.main.util.graphics.Matrix;
 ...
 */
public class SensorsActivity extends EnrootActivity implements SensorEventListener,
        LocationListener {
    ...
    public void onSensorChanged(SensorEvent evt) {
        ...
        if (evt.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            if (AugmentedReality.useDataSmoothing) {//if to use lowpass filter
        ...
        //Logger.d("", Navigation.getAzimuth() +"     "+ Navigation.getPitch()+" /t"+ Navigation.getRoll()+"");
